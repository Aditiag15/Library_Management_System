...
import { login, resetAuthSlice } from "../store/slices/authSlice"; // Adjust the path as needed
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center bg-white p-8 relative">
        <div className="max-w-sm w-full">
          ...
          <form onSubmit={handleLogin}>
            ...
            <div className="mb-4">
              <input type="password" value={password} onChange={(e) => setPassowrd(e.target.value)} placeholder="Password" className="w-full px-4 py-3 border border-black rounded-md focus:outline-none" />
            </div>
