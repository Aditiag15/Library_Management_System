    ...
    <main className="relative flex-1 p-6 pt-28">
      ...
      <div className="flex flex-col-reverse xl:flex-row">
          ...
          <div className="flex flex-col gap-7 flex-[4]">
            <div className="flex flex-col lg:flex-row gap-7 overflow-y-hidden">
              <div className="flex items-center gap-3 bg-white p-5 min-h-[120px] overflow-y-hidden rounded-lg transition hover:shadow-inner duration-300">
                ...
                <span className="bg-gray-300 h-20 lg:h-full min-w-20 flex justify-center items-center"><img src={bookIcon} alt="book-icon" className="w-8 h-8" /></span>
                <p className="text-lg xl:text-xl font-semibold">Your Borrowed Book List</p>
              </div>
              <div className="flex items-center gap-3 bg-white p-5 min-h-[120px] overflow-y-hidden rounded-lg transition hover:shadow-inner duration-300">
                <span className="w-[2px] bg-black h-20 lg:h-full"></span>
                <span className="bg-gray-300 h-20 lg:h-full min-w-20 flex justify-center items-center"><img src={returnIcon} alt="return-icon" className="w-8 h-8" /></span>
            ...
            <div className="flex flex-col lg:flex-row gap-7">
              <div className="flex items-center gap-3 bg-white p-5 max-h-[120px] overflow-y-hidden rounded-lg transition hover:shadow-inner duration-300">
                <span className="w-[2px] bg-black h-20 lg:h-full"></span>
                <span className="bg-gray-300 h-20 lg:h-full min-w-20 flex justify-center items-center"><img src={browseIcon} alt="browse-icon" className="w-8 h-8" /></span>
        ...
        <div className="flex-[2] flex-col gap-7 lg:flex-row flex lg:items-center xl:flex-col justify-between xl:gap-20 py-5">
          ...
          <div className="flex items-center p-8 w-full sm:w-[400px] xl:w-fit ml-10 mr-5 xl:p-3 2xl:p-6 gap-5 h-fit xl:min-h-[150px] bg-white xl:flex-1 rounded-lg overflow-y-hidden">
