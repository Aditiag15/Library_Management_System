            ...
            <div className="p-6">
              ...
              <form onSubmit={handleReturnBook}>
                <div className="mb-4">
                  ...
                  <input type="email" defaultValue={email} disabled required placeholder="Borrower's Email" className="w-full px-4 py-2 border border-black rounded-md"/>
                ...
                <div className="flex justify-end space-x-4">
                  ...
                  <button className="px-4 py-2 bg-black text-white rounded-md hover:bg-gray-800" type="submit">Return</button>
                </div>
              </form>
            </div>
          </div>
